...
@Component
public class WxWorkConsumer extends AbstractMsgConsumer {

    public WxWorkConsumer(MsgRecordMapper msgRecordMapper, StringRedisTemplate redisTemplate) {
    ...
    @RabbitListener(queues = RabbitMqConfig.WXWORK_QUEUE)
